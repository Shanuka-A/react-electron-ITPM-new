...
function Contact() {
    return (
        <div className="a-right">
            <h1 className='text-black-600 dark:text-white' style={{ fontSize: '36px' }}>WELCOME to <span style={{ color: '#007bff' }}>TransLoom</span></h1>
            ...
            <div className="content " style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px' }}>
                ...
                <div className="right-content">
                    ...
                    <div>
                    <h1 className='text-black-600 dark:text-white' style={{ fontSize: '30px', fontWeight: 'bold', textAlign: 'center' }}>Breaking down language barriers, <span style={{ color: '#007bff' }}>one click at a time. </span></h1>
